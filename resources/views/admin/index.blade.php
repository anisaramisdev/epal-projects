        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.logs') }}" class="p-6 bg-white dark:bg-gray-800 border-l-4 border-yellow-500 shadow-sm rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    <div class="text-yellow-600 font-bold text-lg"> Journaux (Logs)</div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="py-3">
                                <span class="px-2 py-1 text-xs rounded {{ $user->role === 'admin' ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700' }}">
                            ...
                            <td class="py-3 text-right">
                                ...
                                <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Supprimer cet utilisateur ?')">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="text-red-500 hover:underline font-bold text-sm">Révoquer l'accès</button>
                                </form>
                                @endif
                            </td>
                        </tr>
