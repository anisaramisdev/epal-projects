<x-app-layout>
    ...
    <div class="min-h-screen bg-cover bg-center bg-fixed bg-no-repeat" style="background-image: url('/images/bg.png')">

        {{-- Overlay to keep content readable, adjust opacity as needed --}}
                                ...
                                <div class="space-y-3">
                                    ...
                                    <a href="{{ route('missions.index') }}"
                                       class="flex items-center justify-between w-full px-6 py-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-bold rounded-2xl transition-all duration-200 group">
                                        <span class="text-sm font-black text-gray-200 dark:text-white uppercase tracking-wide">Voir Planning</span>
                                    ...
                                    <a href="{{ route('engins.index') }}"
                                       class="flex items-center justify-between w-full px-6 py-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-bold rounded-2xl transition-all duration-200 group">
                                        <span class="text-sm font-black text-gray-200 dark:text-white uppercase tracking-wide">Parc Engins</span>
                                        <span class="text-base text-gray-500 group-hover:text-white group-hover:translate-x-1 transition-all duration-200">→</span>
                                    </a>

                                    <a href="{{ route('conducteurs.index') }}"
                                       class="flex items-center justify-between w-full px-6 py-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-bold rounded-2xl transition-all duration-200 group">
                                        <span class="text-sm font-black text-gray-200 dark:text-white uppercase tracking-wide">Conducteurs</span>
                                        <span class="text-base text-gray-500 group-hover:text-white group-hover:translate-x-1 transition-all duration-200">→</span>
                                    </a>
                                </div>
                            </div>
                                    ...
                                    @foreach($zones as $z)
                                        ...
                                        <div>
                                            ...
                                            <div class="w-full bg-gray-100 dark:bg-gray-800 h-1.5 rounded-full overflow-hidden">
                                                <div class="bg-blue-600 dark:bg-blue-500 h-1.5 rounded-full" @style(['width: ' . $perc . '%'])></div>
                                            </div>
                                        </div>
                                    @endforeach
                                @else
