...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Mission Operations (Agents can create and complete missions)
    ...
    // ✅ THE FIX: "complete" route is now protected by auth and in the right place
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    // Manage Missions (Edit & Delete - Admin only)
